...
SELECT procrastinate_defer_periodic_job_v3(%(queue)s, %(lock)s, %(lock_mode)s, %(queueing_lock)s, %(task_name)s, %(priority)s, %(periodic_id)s, %(defer_timestamp)s, %(args)s) AS id;
