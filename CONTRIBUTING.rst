...
For each SQL migration, you'll need a django migration file (this is checked in the
tests). Fortunately, those are autogenerated by running the following command and
comitting the results:

.. code-block:: console

    $ bin/generate-django-migrations
